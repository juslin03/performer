...
<div class="container mt-5 p-5">
    <div class="">
        <h2 style="text-transform: uppercase; margin-left: 15%; margin-top:15px;">{{ $event->e_title }}</h2>
    </div>

    <div class="row">
        <div class='' style="background-size:cover; display flex; justify-content:center;">
            <center>
                <img src="/storage/cover_images/{{ $event->e_img }}" style="width:75%; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);border-radius:  0.25rem;" class='img-fluid' alt="{{ $event->e_title }}" />
                <div>
                    <h4 class="mt-2 text-center">PROGRAMME</h4>
                    <div class="p-5">
                        <p class='text-center'>{{ $event->e_desc }}</p>
                    </div>
