  ...
  <body class="">
    ...
    <div class="row">
        <div class='' style="background-size:cover; display flex; justify-content:center;">
            <center><img src="images/entrepros.jpg" style="width:75%; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);border-radius:  0.25rem;" class='img-fluid' alt="Bootcamp entre digiteuz" /></center>
                <div>
                    <h4 class="mt-2 text-center">PROGRAMME</h4>

                    <p class='text-center'>Entre PROS est un programme conçu pour les entrepreneurs qui ont besoin <br />d’accompagnement personnalisé pour réussir à créer leur entreprise et <br />pour permettre à cette dernière de prendre l’élan nécessaire avant de gagner en autonomie.</p>
                ...
                <center>
                    ...
                    <tr>
                        ...
                        <td>: 100 Entrepreneurs, débutant ou aspirants</td>
                    </tr>
                    
                    <tr>
                        <td style='font-weight:bold;'>Objectif</td>
                        <td>: Recruter, former des entrepreneurs en leur donnant des formations permettant entre autres de convaincre les investisseurs, d’apprendre à pitcher ou encore un accompagnement pour une leve de fonds</td>
                    </tr>
                                <tr>
...
if (isset($_POST['save'])) {
    ...
    $req = $conn->prepare(
        'INSERT INTO performe_db.pros SET nom = :nom, prenom = :prenom, datenaissance = :datenaissance, email = :email, phone = :phone, commune = :commune, form_survey = :form_survey, genre = :genre, projet_survey = :projet_survey, nomprojet = :nomprojet, tic_survey = :tic_survey, info_survey = :info_survey, projet_desc = :projet_desc, lien = :lien, reg_date = :reg_date'
    );
    $req->execute([
        'nom' => $nom,
        'prenom' => $prenom,
