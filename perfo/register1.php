...
<html lang="en">
  ...
  <body class="">
    <div class="off-canvas-wrap">
      ...
      >
        BOOTCAMP ENTRE-DIGITEUZ
      </h2>
    </div>
    <div class="row">
        <div class='' style="background-size:cover; display flex; justify-content:center;">
            <center><img src="images/entredigiteuz.jpeg" style="width:75%; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);border-radius:  0.25rem;" class='img-fluid' alt="Bootcamp entre digiteuz" /></center>
                <div>
                    <h4 class="mt-2 text-center">PROGRAMME</h4>

                    <p class='text-center'>Entre Digiteuz est un programme de formation conçu spécialement pour les femmes qui ont un business à adapter au digital.</p>
                ...
                <center>
                  ...
                  <tr>
                        ...
                        <td width="90%">: Samedi  26 Septembre 2020</td>
                    </tr>
                    <tr>
                        <td style='font-weight:bold;'>Session2</td>
                        <td>: Samedi  03 Octobre 2020</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>: Recruter, former et accompagner des femmes  ayant besoin du digital comme leviers pour booster leur business</td>
                    </tr>
                    

                                <tr>
                                    <td style='font-weight:bold;'>Module 1</td>
                                    <td>: Impact du digital sur mes affaires</td>
                                </tr>
                                <tr>
                                    <td style='font-weight:bold;'>Module 2</td>
                                    <td>: Les opportunités du digital pour mes affaires</td>
                                </tr>
                                <tr>
                                    <td style='font-weight:bold;'>Module 3</td>
                                    <td>: Quels business model adaptés pour mes affaires sur le numérique</td>
                                </tr>
                                <tr>
                                    <td style='font-weight:bold;'>Module 4</td>
                                    <td>: Outils accessibles et utiles pour mes affaires</td>
                                </tr>
                                <tr>
                                    <td style='font-weight:bold;'>Exercice</td>
                                    <td>: Adapter mes affaires au Numérique.</td>
                                </tr>
                                <tr>
                                  <td style='font-weight:bold;'>Module 5</td>
                                  <td> Leadership : Développer son leadership personnel</td>
                                </tr>
                                <tr>
          ...
          <div>
              ...
              <table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><form class="row needs-validation" id="regForm" novalidate>
...
if (isset($_POST['save'])) {
    ...
    $req = $conn->prepare(
        'INSERT INTO performe_db.digiteuz SET nom = :nom, prenom = :prenom, datenaissance = :datenaissance, email = :email, phone = :phone, commune = :commune, form_survey = :form_survey, genre = :genre, projet_survey = :projet_survey, nomprojet = :nomprojet, tic_survey = :tic_survey, info_survey = :info_survey, projet_desc = :projet_desc, lien = :lien, reg_date = :reg_date'
    );
    $req->execute([
        'nom' => $nom,
        'prenom' => $prenom,
